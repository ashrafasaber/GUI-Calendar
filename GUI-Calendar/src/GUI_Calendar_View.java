...
public class GUI_Calendar_View extends JPanel implements ChangeListener{
	...
	public GUI_Calendar_View(GUI_Calendar_Model model)
	{
		...
		model.createEvent("Cinema","11/21/2017","12:00","13:00");		 
		dayViewTableEventUpdate(model);
	...
	private void createButtonUserInput()
	{
		...
		JTextField inputEndTime = new JTextField(10);

		inputDate.setToolTipText("MM/DD/YYYY");
		inputStartTime.setToolTipText("00:00");
		inputEndTime.setToolTipText("00:00");

		JLabel eventTitle = new JLabel("Event Title");		
		JLabel eventDate = new JLabel("Date MM/DD/YYYY");
		JLabel startTime = new JLabel("Start (00:00)");
		JLabel endTime = new JLabel("Start (00:00)");

		eventTitle.setBackground(Color.white);
		eventDate.setBackground(Color.white);
		...
		createEventDialogue(panel, inputTitle, inputDate, inputStartTime, inputEndTime);
	}
...
// reference: http://www.dreamincode.net/forums/topic/207123-change-the-shape-of-jbutton/